...
public class StructureReceiverREQ implements KvmSerializable {
    ...
    public StructureReceiverREQ() {
    }

    public StructureReceiverREQ(int roleID, int userID) {
        RoleID = roleID;
        UserID = userID;
    }

    public StructureReceiverREQ(int roleID, int userID, String userName, String nativeID) {
        RoleID = roleID;
        UserID = userID;
        UserName = userName;
        NativeID = nativeID;
