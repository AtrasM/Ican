...
public class AdapterQueueMessage extends RecyclerSwipeAdapter<AdapterQueueMessage.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (item.getQueueStatus() == QueueStatus.ERROR) {
            viewHolder.lnTry.setVisibility(View.VISIBLE);
            viewHolder.lnError.setVisibility(View.VISIBLE);
            viewHolder.imgState.setImageDrawable(Resorse.getDrawable(R.drawable.ic_error));
            new CustomFunction(App.CurentActivity).setHtmlText(viewHolder.txtErrorMessage, item.getStrError());

        } else {
            viewHolder.imgState.setImageDrawable(Resorse.getDrawable(R.drawable.ic_waiting));
            viewHolder.lnTry.setVisibility(View.GONE);
            viewHolder.lnError.setVisibility(View.GONE);
        }
        viewHolder.imgTry.setOnClickListener(view -> listenerAdapterMessageQueue.onTry(item));
    }
