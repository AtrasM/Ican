...
public class StructureFwdReply implements Serializable {
    ...
    public StructureFwdReply() {
    }

    public StructureFwdReply(int sender_user_id, int sender_role_id, String senderFullName, String senderRoleName, String subject, String content, boolean reply) {
    ...
    public StructureFwdReply(int sender_user_id, int sender_role_id, String senderFullName, String senderRoleName, String subject, String content, ArrayList<StructureAttach> structureAttaches, boolean reply) {
        this.sender_user_id = sender_user_id;
        this.sender_role_id = sender_role_id;
        SenderFullName = senderFullName;
        SenderRoleName = senderRoleName;
