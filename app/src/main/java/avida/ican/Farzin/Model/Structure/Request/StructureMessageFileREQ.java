...
public class StructureMessageFileREQ implements KvmSerializable {
    ...
    public StructureMessageFileREQ() {
    }

    public StructureMessageFileREQ(String fileName, String fileBinary, String fileExtension) {
        FileName = fileName;
        FileBinary = fileBinary;
        FileExtension = fileExtension;
    }
