...
public class AdapterSentMessageList extends RecyclerView.Adapter<AdapterSentMessageList.ViewHolder> {
    ...
    public AdapterSentMessageList(List<StructureMessageDB> itemList, ListenerAdapterMessageList listenerAdapterMessageList) {
    ...
    @NonNull
    @Override
    public AdapterSentMessageList.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
